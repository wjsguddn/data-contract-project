...
- 계약서: "갑: 주식회사 ABC, 서울시 강남구 테헤란로 123, 사업자등록번호 123-45-67890" 
  → 질문: "등기부등본과 일치하는가?" 
  → MANUAL_CHECK_REQUIRED
  → manual_check_reason: "계약서에는 '주식회사 ABC', '서울시 강남구 테헤란로 123', '사업자등록번호 123-45-67890'으로 기재되어 있습니다. 이 정보가 등기부등본과 정확히 일치하는지 AI가 직접 확인할 수 없습니다."

- 계약서: "대표이사 홍길동"
  → 질문: "적법한 권한을 가진 대표자인가?"
  → MANUAL_CHECK_REQUIRED
  → manual_check_reason: "계약서에는 '대표이사 홍길동'으로 기재되어 있습니다. 이 대표자가 적법한 권한을 가진 자인지 AI가 직접 확인할 수 없습니다."

- 계약서: "날인란: [   ]"
  → 질문: "날인이 되어 있는가?"
  → MANUAL_CHECK_REQUIRED
  → manual_check_reason: "계약서에 날인란이 있습니다. 실제로 날인이 되어 있는지는 물리적 문서를 확인해야 하므로 AI가 직접 확인할 수 없습니다."
...
**MANUAL_CHECK_REQUIRED 작성 규칙 (매우 중요!):**
- manual_check_reason에는 **반드시 계약서의 실제 내용을 구체적으로 인용**할 것
- 형식: "[조항 위치]에는 '[실제 내용]'으로 기재되어 있습니다. [왜 AI가 확인할 수 없는지 설명]"
- 조항 위치: "서문" 또는 "제N조"를 반드시 포함
- 예시: "서문에는 '케이텔레콤 주식회사', '서울시 강남구 테헤란로 123', '사업자등록번호 123-45-67890'으로 기재되어 있습니다. 이 정보가 등기부등본과 정확히 일치하는지 AI가 직접 확인할 수 없습니다."
- 예시: "제1조에는 '대표이사 홍길동'으로 기재되어 있습니다. 이 대표자가 적법한 권한을 가진 자인지 AI가 직접 확인할 수 없습니다."
- **절대 일반적인 설명만 하지 말 것!** 반드시 조항 위치와 계약서의 실제 내용을 포함해야 함
...
{{
  "results": [
    {{
      ...
      "confidence": 0.95,
      "manual_check_reason": "계약서에는 '케이텔레콤 주식회사', '서울시 강남구 테헤란로 123', '사업자등록번호 123-45-67890'으로 기재되어 있습니다. 이 정보가 등기부등본과 정확히 일치하는지 AI가 직접 확인할 수 없습니다." (MANUAL_CHECK_REQUIRED인 경우만, 반드시 계약서 실제 내용 포함),
      "user_action": "등기부등본과 대조하여 회사명, 주소, 사업자등록번호 확인" (MANUAL_CHECK_REQUIRED인 경우만),
